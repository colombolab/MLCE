...
# neighbourhood cutoff for the generation of the contact map, defined in angstroms.
radius = 6.0
...
if enername is not None:
    ...
    enermat.pop()
    enermat.pop()  # blank lines


if 'topolcontrol' not in vars() or topolcontrol != 1:
    topolcontrol = 0
if 'mlceprint' not in vars() or mlceprint != 1:
    mlceprint = 0
...
structure, protein_length, span, renumbering = toolbox.PDB_CONVERTER(
...
distance_matrix = toolbox.DISTANCE_MATRIX(
    pdbfileaccess, topolcontrol, radius, structure)
...
# ===========================================================================================================================
epitopes_raw, mlce = toolbox.MLCE(
    protein_length, threshold, distance_matrix, energy, mlceprint)
...
# ===========================================================================================================================
if(renumbering == 1):
    scored = toolbox.RENUMBER(span, scored)
